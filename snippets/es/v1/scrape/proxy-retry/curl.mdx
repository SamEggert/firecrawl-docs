...
# Comprobar si el código de estado indica que debemos reintentar con el proxy stealth
if [[ "$STATUS_CODE" == "401" || "$STATUS_CODE" == "403" || "$STATUS_CODE" == "500" ]]; then
    echo "Código de estado $STATUS_CODE recibido; reintentando con el proxy stealth"
